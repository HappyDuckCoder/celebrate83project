            ...
            {isSignedIn ? (
                <SignOutButton>
                    <div className="group relative">
                        ...
                        <span className="absolute left-1/2 -translate-x-1/2 top-[-20px] z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-sm bg-white px-3 py-1 min-w-[100px] text-center rounded-xl shadow-md border border-gray-200 pointer-events-none">
                            Đăng xuất
                        </span>
                    </div>
                </SignOutButton>
